...
//         if (err) {
//           console.error(err);
//           return next(new AppError('Error uploading file'));
//         }
...
//           await Photo.create({ product, photo: photoUrl });
  
//          let photo = Product.findByIdAndUpdate(product,{photo : photoUrl},{new :true})
